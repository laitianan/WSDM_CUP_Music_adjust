...
###看不懂統計序列的窗口，樣本出現的次數有什麼用，是統計出現的頻率意思嗎
...
"""
7377418 tm_year=1970, tm_mon=3, tm_mday=27
7377417 tm_year=1970, tm_mon=3, tm_mday=27
1484236800:m_year=2017, tm_mon=1, tm_mday=13
1471190400 tm_year=2016, tm_mon=8, tm_mday=15
7377417: tm_year=1970, tm_mon=3, tm_mday=27, tm_hour=17, tm_min=16, tm_sec=57, tm_wday=4

"""
#timestamp = 1471190400
#
##转换成localtime
...
# concat.groupby(by='msno')['timestamp'].agg("mean").to_dict()
